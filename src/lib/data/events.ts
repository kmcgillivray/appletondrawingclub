...
export const eventsData: { events: Event[] } = {
  events: [
    ...
    {
      id: "expressive-portrait-sketching-in-charcoal-2025-09-17",
      title: "Expressive Portrait Sketching in Charcoal",
      date: "2025-09-17",
      time: "6:00-9:00PM",
      location: {
        name: "Richeson School of Art",
        address: {
          streetAddress: "1020 S Lawe St",
          addressLocality: "Appleton",
          addressRegion: "WI",
          postalCode: "54915",
        },
      ...
      summary:
        "Hands-on charcoal portrait workshop with instructor Kevin McGillivray at Richeson School of Art.",
      description:
        "Learn expressive portrait sketching techniques using charcoal in this hands-on workshop. We'll explore different charcoal techniques, from light sketching to bold, dramatic strokes. Perfect for beginners and experienced artists looking to expand their portrait skills.",
      url: "/expressive-portrait-sketching-in-charcoal",
      image_url:
        "https://res.cloudinary.com/db5mnmxzn/image/upload/c_fill,g_center,h_750,w_750/v1755020957/IMG_7548_jprsgc.jpg",
      price: 75,
      event_type: "workshop",
      status: "registration_open",
    },
    ...
    },
    {
      ...
      summary: "Mixed pose life drawing session focused on movement and gesture.",
      description:
    ...
    },
    {
      ...
      summary: "Celebrating one year of Appleton Drawing Club with mixed pose portrait drawing.",
      description:
