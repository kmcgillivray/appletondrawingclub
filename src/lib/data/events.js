export const eventsData = {
  "events": [
    ...
    },
    {
      ...
      "location": "The Photo Opp Studio",
      "model": "Emma",
      "description": "Mixed pose figure drawing session with a baseball theme.",
      ...
      "image_url": "https://res.cloudinary.com/db5mnmxzn/image/upload/c_fill,g_center,h_750,w_750/v1725293285/IMG_0262_aaxson.jpg",
      "price": "$15",
    ...
    },
    {
      ...
      "date": "2025-09-17",
      "time": "6:00-9:00PM",
      "location": "Richeson School of Art",
      "instructor": "Kevin McGillivray",
      "description": "Learn expressive portrait sketching techniques using charcoal in this hands-on workshop.",
      "url": "/expressive-portrait-sketching-in-charcoal",
      "image_url": "https://res.cloudinary.com/db5mnmxzn/image/upload/c_fill,g_center,h_750,w_750/v1755020957/IMG_7548_jprsgc.jpg",
      "event_type": "workshop",
      "status": "registration_open"
    },
    {
      ...
      "date": "2025-09-24",
      "time": "7:00-9:00PM",
      "location": "FSM Art House",
      "model": "TBD",
      "description": "Extended pose portrait drawing session in a relaxed setting.",
    ...
    },
    {
      ...
      "location": "The Photo Opp Studio",
      "description": "Family friendly fantasy poses! Fairies, warriors, and fantastic foes.",
    ...
    },
    {
      ...
      "date": "2025-07-09",
      "time": "7:00-9:00PM",
      "location": "Commodore Club",
      "description": "Portrait drawing session where participants draw each other.",
    ...
    },
    {
      ...
      "date": "2025-06-18",
      "time": "6:00-8:00PM",
      "location": "Paine Art Center and Gardens",
    ...
    },
    {
      ...
      "date": "2025-06-11",
      "time": "6:00-9:00PM",
      "location": "Richeson School of Art & Gallery",
      "instructor": "Kevin McGillivray",
    ...
    },
    {
      ...
      "time": "7:00-9:00PM",
      "location": "The Photo Opp Studio",
      "description": "Mixed pose life drawing session focused on movement and gesture.",
    ...
    },
    {
      ...
      "time": "7:00-9:00PM",
      "location": "The Photo Opp Studio",
      "description": "Celebrating one year of Appleton Drawing Club with mixed pose portrait drawing.",
    ...
    },
    {
      ...
      "image_url": "https://res.cloudinary.com/db5mnmxzn/image/upload/v1742585378/250226_ADCWildlifeDrawing_M4W_012_teyyz9.jpg",
      "event_type": "special_event",
      "status": "completed"
    },
    {
    ...
    },
    {
      ...
      "time": "7:00-9:00PM",
      "location": "The Photo Opp Studio",
      "description": "Mixed pose life drawing session - the very first Appleton Drawing Club session!",
