...
<svelte:head>
  <title>Book a private event - Appleton Drawing Club</title>
  <meta name="description" content="Book a private life drawing session for your group, corporate event, or party with Appleton Drawing Club. Custom sessions tailored to your needs." />
</svelte:head>
...
<section class="container">
  ...
  <p>If you have any questions about private events, please <a href="/contact">contact us</a>. We look forward to drawing with you!</p>
  <iframe class="airtable-embed" src="https://airtable.com/embed/appZ8b20NKIBuFhjp/pagqBjJp8BIg2ytWY/form" frameborder="0" width="100%" height="750" style="background: transparent; border: 1px solid #ccc;" title="Private Event Booking Form"></iframe>
</section>